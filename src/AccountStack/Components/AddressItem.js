...
export default class AddressItem extends Component {
  ...
  render() {
    ...
    return (
        ...
        <View  style={{borderColor:'#cbcbcb',borderBottomWidth:1,paddingBottom:20}}>
            <Text style={styles.heading}>{item.save_type}</Text>
            <Text style={styles.address}>{`${item.house_flat_no},${item.landmark},${item.location}`} </Text>
