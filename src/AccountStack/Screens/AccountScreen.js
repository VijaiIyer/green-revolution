...
import {TouchableNativeFeedback,View,StyleSheet,Alert,AsyncStorage} from 'react-native';

export default class ButtonFullExample extends Component {
    constructor(props)
    { super(props);
        this.state={
          name:global.user_detail.name,
          mobile:global.user_detail.contact,
          email:global.user_detail.email,
        }
    }
  render() {
    return (
      <Container>
        ...
        <Text style={styles.details}>{this.state.mobile} {'\u2022'} {this.state.email}</Text>
        </View>
