...
export default class MapScreen extends Component {
  constructor(props) {
    ...
    var name=this.item.save_type;
    console.log(name);
    if(this.item.save_type==='1')
     name='Home'
    if(this.item.save_type==='2')
     name='Work'
    if(this.item.save_type==='3')
     name='Other'
     console.log(name);
    ...
    this.state = {
      ...
      house_flat_no:this.item.house_flat_no,
        ...
        <View style={styles.container}>
          ...
          <View>
            ...
            <Item floatingLabel last>
              ...
              <Input 
                style={{fontSize:14}}
                value={this.state.house_flat_no}
                onChangeText={(value)=>{this.setState({house_flat_no:value})}}
              />
            </Item>
            <Item floatingLabel last>
              ...
              <TouchableNativeFeedback
                onPress={()=>{
                  ...
                  if(this.state.name==='Home')
                    ...
                    save='3';
                    temp.save_type=save;
                    temp.house_flat_no=this.state.house_flat_no;
