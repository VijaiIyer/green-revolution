...
import { TouchableNativeFeedback,Animated,Text, View, ActivityIndicator, Button,StyleSheet,Dimensions,TouchableWithoutFeedback,TextInput,ToastAndroid } from 'react-native';
            ...
            <TouchableNativeFeedback
                onPress={()=>{
                  ...
                  this.props.navigation.state.params.add_Address({
                    house_flat_no:this.state.house,
              ...
              <Text  style={{textAlignVertical:"center",textAlign:'center',fontSize:16,fontWeight:'bold',color:'white'}}>PICK THIS LOCATION</Text>
              </View>
              </TouchableNativeFeedback>
            </View>
          </Animated.View>  
